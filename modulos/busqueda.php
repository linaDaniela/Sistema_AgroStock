...
<head>
    ...
    <title>Búsqueda - AgroStock</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <form class="d-flex me-3" action="index.php" method="GET">
                    ...
                    <input class="form-control me-2" type="search" name="q" placeholder="Buscar productos..." aria-label="Buscar" value="<?php echo htmlspecialchars($_GET['q'] ?? ''); ?>">
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-8">
                ...
                <p class="text-muted">Buscando: "<strong><?php echo htmlspecialchars($_GET['q'] ?? ''); ?></strong>"</p>
            </div>
    ...
    <div class="container">
        ...
        <?php else: ?>
            <div class="text-center py-5">
                ...
                <p class="text-muted">No hay productos que coincidan con tu búsqueda: "<strong><?php echo htmlspecialchars($_GET['q'] ?? ''); ?></strong>"</p>
                <div class="mt-3">
